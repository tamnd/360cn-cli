...
Most of these come down to network reality or how 360cn serves its data,
not a bug. Fill this page out with the site-specific cases as you find them.

## Requests start failing or returning 429

360cn rate-limits like any public site. cn360 already paces
...
Where a surface is gated, cn360 reads a cookie or token you supply
...
`cn360`, add that directory to your `PATH`. See
[installation](/getting-started/installation/).

## Seeing what cn360 actually did
