...
// HTTP behaviour is covered in 360cn_test.go.

func TestDomainInfo(t *testing.T) {
	info := Domain{}.Info()
	if info.Scheme != "360cn" {
		t.Errorf("Scheme = %q, want 360cn", info.Scheme)
	}
...
func TestHostWiring(t *testing.T) {
	...
	if want := "360cn://page/wiki/Go"; u.String() != want {
	...
	got, err := h.ResolveOn("360cn", "about")
	if err != nil || got.String() != "360cn://page/about" {
		t.Errorf("ResolveOn = (%q, %v), want 360cn://page/about", got.String(), err)
	}
}
